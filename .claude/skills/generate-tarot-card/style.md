...
**AND NOBODY IS NUDE, WHICH COSTS FOUR CARDS' WORTH OF ICONOGRAPHY AND IS NOT
NEGOTIABLE.** The Lovers, The Devil, The Star and The World are nude in the
Rider-Waite tradition, and all four were refused on the first batch -- the only
four refusals that were not about violence, and every one of them a card where
the classic image is unclothed. Thin pale shifts and ragged wraps read the same
way at 90px, keep the vulnerability the cards are about, and generate. Do not
...
restrained, whatever the sentence meant to modify. The wreath is what is tied.
Rewritten so the figure STANDS with arms open and the cord belongs unambiguously
to the wreath, it generates. A refusal is sometimes not about your subject at all
-- it is about the nearest available reading of your grammar.

**AND NO ANATOMY AS AN OBJECT.** Justice was refused for `a heart in one pan` --
an organ on a scale beside a sword and a blood pool. `a carved stone heart` keeps
the symbol exactly (love weighed against money, the coin lower) and reads
identically at 90px. Three refusal families now, and none of them was the deck's
MOOD: depicted harm, nudity, and body parts as props. The tone has never once
been the thing that got rejected.

FIXED IN THE SCENE LINES ONLY, DELIBERATELY. The obvious fix is a line in the
style block, and it is the wrong one -- that would bump the block to v3 and leave
sixteen cards at v2, which is the mixed deck the version stamp exists to catch.
...
- 11_justice: A blindfolded figure enthroned in a bare hall, sword held upright with its point set in a spreading pool at the foot of the throne, scales in the other hand — a carved stone heart in one pan, a coin in the other, the coin lower. Frontal, rigidly symmetrical, austere flat light.
...
- 15_devil: A horned figure squatting on an inverted plinth in a low cavern, two figures in ragged grey wraps chained at the neck below it, the chains slack enough to step out of. A torch held downward, guttering, its embers falling short of them onto wet stone. Cramped, ember-lit, ceiling close overhead.
...
- 17_star: A figure in a thin pale shift kneeling at the lip of a black pool beneath one enormous star and seven small ones, pouring from two vessels. What she pours runs dark and spreads. One bare tree, one bird. Wide, nocturnal, quiet, the water absolutely flat.
...
- 21_world: A figure in a thin pale shift standing at the centre of a great wreath of thorn and bone, arms open, feet just clear of a dark globe below. The wreath itself is tied at four points with red cord. At the four corners, a bull, a lion, an eagle and an angel, all rendered as skulls. Frontal, iconic, void black background.
